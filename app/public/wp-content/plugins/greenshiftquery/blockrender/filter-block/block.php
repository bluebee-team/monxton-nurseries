...
class FilterBlock {
        ...
        switch ( $resourceType ) {
                ...
                switch ( $designType ) {
                    case 'checkbox':
                        ...
                        case 'select':
                            ...
                            break;
                        case 'tags':
                            $data = $this->gspbTags( $filterOptions, $filterType, $key, $filterId, $blockId, $attributes_arr, $filterRelation, $filter_operator );
                            echo $data;
                            break;
                        case 'rangeslider':
            ...
            case 'TITLE':
                if ( 'searchinput' === $designType ) {
                  $data = $this->gspbSearchInput( $filterId, $blockId, $attributes_arr );
                  echo $data;
                }
                break;
     ...
     * Search Input
     */
    public function gspbSearchInput( $filterId = '', $blockId = '', $attributes_arr = array() ) {
        $html = '';
        ...
        $html .= '<input type="text" id="' . $forId . '" class="gspb-search" data-filter="search" name="' . $forName . '" placeholder="Search Here..." data-key="gspbfilter" data-connection="' . $filterId . '" />';
        $html .= '</div>';
        $html .= '</div>';
        return $html;
    }
